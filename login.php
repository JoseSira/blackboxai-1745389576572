    ...
    if ($username && $password) {
        ...
        if ($result['success']) {
            ...
            if (isset($_SESSION['redirect_after_login'])) {
                ...
                header('Location: ' . ($result['is_admin'] ? 'admin.php' : 'dashboard.php'));
            }
            exit;
        } else {
...
<body class="bg-gray-100 min-h-screen">
    ...
    <div class="max-w-md mx-auto px-4 py-8">
        <div class="bg-white shadow-lg rounded-lg p-8">
            ...
            <div class="mt-6 text-center">
                ...
                <a href="register.php" class="text-blue-500 hover:text-blue-600 font-semibold">
                    Registrarse
                </a>
            </div>
    ...
    <div id="loading" class="fixed inset-0 bg-black bg-opacity-50 items-center justify-center hidden">
        <div class="bg-white p-4 rounded-lg shadow-lg">
            ...
            <p class="mt-2 text-gray-600">Iniciando sesión...</p>
        </div>
    </div>
